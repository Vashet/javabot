...
class MockServletRequest implements HttpServletRequest {
    ...
    public MockServletRequest(final boolean loggedIn) {
        if (loggedIn) {
            ...
            cookies = new Cookie[]{new Cookie(JavabotConfiguration.SESSION_TOKEN_NAME,
